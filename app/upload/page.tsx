...
//   const [formState, action, isPending] = useActionState(uploadShortsAction, { error: {} })
...
//       <h1 className='mb-6 text-2xl font bold  text-center'>Upload Short</h1>
...
//               <div className='border-red-500 bg-red-100'>
...
const page = () => {
  ...
  // ✅ Fix: Prevent hydration mismatch by rendering Upload only after client has mounted
